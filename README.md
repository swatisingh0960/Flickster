...
**Flicks app** shows the latest movies currently playing in theaters. The app utilizes the Movie Database API to display images and basic information about these movies to the user.
...
<img src='https://github.com/swatisingh0960/Flickster/blob/master/ezgif-326118927.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Faced the challenge to include the Butterknife libraries.
